...
class MyApp(QWidget):
	...
	def on_connect(self, mqttc, obj, flags, rc):
		self.mqttc.subscribe("painlessMesh/from/#", 0)
...
##########################################################################################################
		...
		try:
			...
			# self.mqttc.connect("170.79.168.234", Config.PORTA_MQTT_LOCAL, 60)
			self.mqttc.connect("172.17.1.228", Config.PORTA_MQTT_LOCAL, 60)
