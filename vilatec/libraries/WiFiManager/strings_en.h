...
const char HTTP_ROOT_MAIN[]        PROGMEM = "<h1>{v}</h1><h3>Configurações</h3>";
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Salvando Credenciais<br/>Tentando Conectar o dispositivo na rede<br />caso falhe, tente novamente.</div>";
const char HTTP_PARAMSAVED[]       PROGMEM = "<div class='msg S'>Saved<br/></div>";
const char HTTP_END[]              PROGMEM = "</div></body></html>";
const char HTTP_ERASEBTN[]         PROGMEM = "<br/><form action='/erase' method='get'><button class='D'>Apagar Configurações</button></form>";
...
const char HTTP_STATUS_OFF[]       PROGMEM = "<div class='msg {c}'><strong>Não conectado</strong> a {v}{r}</div>";
...
const char HTTP_STATUS_NONE[]      PROGMEM = "<div class='msg'>Sem AP configurado</div>";
...
#else 
	const char HTTP_INFO_esphead[]    PROGMEM = "<h3>Evolution</h3><hr><dl>";
