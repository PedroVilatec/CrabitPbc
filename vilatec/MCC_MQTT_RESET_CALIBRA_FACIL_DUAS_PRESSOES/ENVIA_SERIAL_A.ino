...
double freq = map(analog_value, 0, 255 , 0, 66);
  ...
  Serial.println((String)"<"+temperatura+","+umidade+","+pressao1+","+pressao2+","+freq+","+status_inversor+","+
  status_h2s+","+status_reset_inv+","+status_reset_12v+","+status_bomba+","+an_value+">");

  //   Serial.println((String)"<"+temperatura+","+umidade+","+pressao_absoluta+","+x+","+status_inversor+","+
  // status_h2s+","+status_reset_inv+","+status_reset_12v+","+status_bomba+","+an_value+">");
