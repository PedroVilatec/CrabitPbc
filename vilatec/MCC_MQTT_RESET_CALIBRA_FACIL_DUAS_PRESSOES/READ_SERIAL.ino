void READ_SERIAL() {
  while (Serial.available() > 0) {
    ...
    if ((character == '\n') || (character == '\r')) {
      ...
      //*******************************CONFIGURA O HORARIO DO TESTE DE PRESSÃO **************************NHGHUI


      //      if (Data.substring(0, 5) == "MPX_A") {
      //        char buffer[10];
      //        Data.substring(6, 15).toCharArray(buffer, 10);
      //        //float valor = Data.substring(6, 15).toFloat();
      //        float valor = atof(buffer);
      //        calibra_pressao1 = valor;
      //        Serial.println(valor, 4);
      //        EEPROM.writeFloat(20, valor);
      //        delay(5000);
      //      }
      //      if (Data.substring(0, 5) == "MPX_B") {
      //        char buffer[10];
      //        Data.substring(6, 15).toCharArray(buffer, 10);
      //        float valor = atof(buffer);
      //        calibra_pressao2 = valor;
      //        EEPROM.writeFloat(30, valor);
      //        Serial.println(valor, 4);
      //        delay(5000);
      //      }
      ...
      if (Data.substring(0, 6) == "EEPROM") {
        ...
        Serial.println();
        //Serial.print("H_TESTE\t");Serial.print("M_TESTE\t");Serial.print("CALIB_S_A\t");Serial.print("CALIB_S_B\t");
        //Serial.print("DUR_TESTE\t");Serial.print("P_IDEAL_TE\t");Serial.print("T_ALARME\t");Serial.print("AUTO_SET\t");
        //Serial.print("DUR_TROCA\t");Serial.print("P_IDEAL_TR\t");Serial.print("H_TROCA\t");Serial.println("M_TROCA");
